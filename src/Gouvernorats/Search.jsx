...
const regions_tunisie = [ "Ariana", "Beja", "Ben Arous", "Bizerte", "Gabès", "Gafsa", "Jendouba", "Kairouan", "Kasserine", "Kébili", "Kef", "Mahdia", "Manouba", "Medenine", "Monastir", "Nabeul", "Sfax", "Sidi Bouzid", "Siliana", "Sousse", "Tataouine", "Tozeur", "Tunis", "Zaghouan" ];
const categories = [  "Clinique",
  "SOS Infirmerie",
  "Pharmacie",
  "Ambulance",
  "Centre médicale",
  ...
  return (
    <div className="header-container-search">
      <div className="search-container-search">
        ...
        <div className="search-section-search">
          <label htmlFor="activity">Mot Clé</label>
          <Select
